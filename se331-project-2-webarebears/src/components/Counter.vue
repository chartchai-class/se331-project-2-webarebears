<template>
    <div v-if="loaded">
        ...
        <section class="flex justify-between items-center mx-auto mt-10 layout-container">
            <!-- h5 title on the left with 40% width -->
            <h5 v-if="!expired" class="h5-center">A Return to <span> the City of Angels </span></h5>
            <h5 v-else class="h5-center">Welcome to Olympic 2028!</h5>
            
            <!-- Description on the right with 60% width -->
            <p class="description-center">In 2028, the world will turn its eyes to Los Angeles as the city prepares to host the Olympic Games for the third time. Known for its dynamic culture, iconic skyline, and innovative spirit, LA will once again take center stage in the global sports arena. With a blend of historic venues and state-of-the-art facilities, athletes from every corner of the globe will come together to compete for glory, inspired by the city’s vibrant energy. As we approach this momentous event, the excitement is building for a truly unforgettable celebration of athleticism, unity, and diversity in the heart of Southern California.</p>
        </section>
    ...
    methods:{
        ...
        showRemaining(){
            const timer = setInterval(() => {
                const now = new Date();
               // const end = new Date(2024,10,22,10,10,10);
